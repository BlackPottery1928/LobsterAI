...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    lowCreditOfferFirstAction: '限时{discount}折 升级套餐',
    lowCreditOfferReturningAction: '限时{discount}折 去购买',
    lowCreditOfferTaskFirstTitle: '积分已用尽，限时{discount}折升级订阅套餐',
    lowCreditOfferTaskReturningTitle: '积分已用尽，限时购买{discount}折',
    lowCreditOfferTaskDescription: '优惠剩余 {time}，需购买 token 继续使用。',
  ...
  en: {
    ...
    lowCreditOfferClose: 'Close offer',
    ...
    lowCreditOfferFirstAction: '{discount}0% price · Upgrade',
    lowCreditOfferReturningAction: '{discount}0% price · Buy now',
    ...
    lowCreditOfferTaskDescription: 'Offer ends in {time}. Purchase tokens to continue.',
