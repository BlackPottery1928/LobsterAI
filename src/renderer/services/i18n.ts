...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkQuestionDockWaiting: '正在等待你的回答',
    coworkQuestionDockSkip: '跳过',
    coworkQuestionDockSubmit: '提交回答',
    coworkQuestionDockOther: '补充你的想法，或输入其他答案',
    coworkQuestionDockNavigation: '切换问题',
    coworkQuestionDockPrevious: '上一题',
    coworkQuestionDockNext: '下一题',
    coworkQuestionDockRecommended: '（推荐）',
    coworkQuestionDockClose: '收起问题，稍后回答',
    coworkQuestionDockQueue: '还有 {count} 组问题等待回答',
    coworkQuestionDockExpired: '此提问已过期',
    coworkQuestionDockSending: '正在提交',
    // 通用
    save: '保存',
    cancel: '取消',
    saving: '保存中...',
    ...
    intranetLoginPasswordRequired: '请输入密码',
    intranetLoginCancelled: '已取消登录',
    intranetLoginFailed: '登录失败，请稍后重试',
    intranetLoginInvalidCredentials: '工号或密码错误',
    intranetLoginTimeout: '登录超时，请稍后重试',
    intranetLoginNetworkError: '网络异常，请检查内网连接后重试',
    intranetLoginInvalidResponse: '登录服务响应异常，请联系管理员',
    collapse: '收起',
    expand: '展开',
    ...
    modelSelectorSubscriptionOfferDesc: '当前可享{discount}折订阅优惠，购买后即可使用更多模型。',
    modelSelectorBoostOfferDesc: '当前可享{discount}折加油包优惠，购买后即可继续使用更多模型。',
    ...
    coworkActivityThoughtProcess: '深度思考',
    ...
    coworkActivityLiveEdit: '正在修改 {target}',
    coworkActivityLiveEditGeneric: '正在修改文件',
    coworkActivityLiveWrite: '正在写入 {target}',
    coworkActivityLiveWriteGeneric: '正在写入文件',
    coworkActivityLiveGenerating: '正在生成文件内容',
    coworkActivityStatusReplying: '正在生成回复',
    coworkActivityStatusCommand: '正在运行命令',
    coworkActivityStatusCommandOutput: '正在等待命令输出',
    coworkActivityStatusReading: '正在读取文件',
    coworkActivityStatusReadingSkill: '正在读取技能说明',
    coworkActivityStatusWriting: '正在写入文件',
    coworkActivityStatusEditing: '正在修改文件',
    coworkActivityStatusSearchingFiles: '正在搜索文件',
    coworkActivityStatusSearchingWeb: '正在搜索网页',
    coworkActivityStatusFetchingWeb: '正在读取网页',
    coworkActivityStatusBrowser: '正在操作浏览器',
    coworkActivityStatusMemory: '正在查找记忆',
    coworkActivityStatusTodo: '正在更新任务清单',
    coworkActivityStatusAsking: '正在准备提问',
    coworkActivityStatusCron: '正在设置定时任务',
    coworkActivityStatusSubagentIo: '正在与子 Agent 通信',
    coworkActivityStatusMessaging: '正在发送消息',
    coworkActivityStatusViewingImage: '正在查看图片',
    coworkActivityStatusTool: '正在调用工具',
    coworkActivityDoneCommandGeneric: '运行了命令',
    coworkActivityDoneRead: '读取了 {target}',
    coworkActivityDoneReadGeneric: '读取了文件',
    coworkActivityDoneWrite: '写入了 {target}',
    coworkActivityDoneWriteGeneric: '写入了文件',
    coworkActivityDoneEdit: '修改了 {target}',
    coworkActivityDoneEditGeneric: '修改了文件',
    coworkActivityDoneTool: '使用了 {target}',
    coworkActivityDoneSpawnSubagent: '启动了子 Agent',
    coworkActivityDoneImage: '生成了图片',
    coworkActivityDoneVideo: '生成了视频',
    coworkActivityLiveTool: '正在使用 {target}',
    coworkToolWaitingSubagents: '等待子 Agent 完成',
    coworkActivityLiveWaitSubagents: '正在等待子 Agent 完成',
    coworkActivityWaitSubagentSummary: '子 Agent 已完成，正在等待汇总',
    ...
    updateGrayUnavailable: '此更新暂不可用，请重新检查更新',
    ...
    lowCreditOfferClose: '关闭付费引导',
    lowCreditOfferFirstBadge: '首充福利',
    lowCreditOfferBalance: '剩余额度 {credits} 积分',
    lowCreditOfferDescription: '积分不足将影响任务执行，请及时充值。',
    lowCreditOfferCountdown: '限时福利 {time}',
    lowCreditOfferRecharge: '充值积分',
    lowCreditOfferUpgrade: '升级套餐',
    lowCreditOfferSubscribe: '订阅套餐',
    lowCreditOfferDiscount: '{discount}折',
    lowCreditOfferDiscountRecharge: '{discount}折充值积分',
    lowCreditOfferLimitedDiscount: '限时{discount}折',
    lowCreditOfferBadgeFirstTop: '首充',
    lowCreditOfferBadgeFirstBottom: '福利',
    lowCreditOfferBadgeLimitedTop: '限时',
    lowCreditOfferBadgeLimitedBottom: '优惠',
    lowCreditOfferTaskFirstTitle: '积分已用尽，{discount}折升级订阅套餐',
    lowCreditOfferTaskReturningTitle: '积分已用尽，限时购买{discount}折',
    ...
    decisionModelSettingsTitle: 'Jev 判断模型',
    decisionModelSettingsDesc: '让助手调用 TypeSafe 的 Jev 判断模型：它不生成文字，只对内容做分类、打分和是非判断，通常一秒内出结果、费用极低，适合批量筛选和分类。需要自备 API Key。',
    decisionModelEnableLabel: '启用 Jev 判断模型',
    decisionModelProviderLabel: '渠道',
    decisionModelProviderOpenRouter: 'OpenRouter',
    decisionModelProviderTypeSafe: 'TypeSafe 官方',
    decisionModelProviderCompatible: '自定义兼容地址',
    decisionModelEndpointLabel: '接口地址',
    decisionModelEndpointHint: '填写完整的请求地址，接口需兼容 TypeSafe 的 /v1/systemone 格式，例如 https://example.com/v1/systemone。',
    decisionModelTest: '测试连接',
    decisionModelTesting: '测试中…',
    decisionModelTestOk: '连接成功 · {model} · {ms} ms',
    decisionModelTestFailed: '连接失败：{error}',
    decisionModelActiveNote: '已生效：助手需要批量分类、打分或判断时会自动调用 Jev。',
    decisionModelNeedsSetup: '填写 API Key 并点击下方「保存」后才会生效。',
    decisionModelUnsavedHint: '修改会在点击下方「保存」后生效。',
    decisionModelExamplesTitle: '试一试，在对话里说：',
    decisionModelExample1: '把这份表格里的 200 条用户评论按情绪和问题类型分类，挑出需要客服跟进的',
    decisionModelExample2: '从这些简历里筛出符合岗位要求的候选人，并按匹配度排序',
    decisionModelExample3: '看看收件箱里哪些邮件今天必须回复',
    decisionModelDataNote: '判断时，相关内容会发送到所选服务。开启或关闭并保存后，OpenClaw 引擎会重启一次。',
    decisionModelErrorMissingApiKey: '还没有填写 API Key',
    decisionModelErrorInvalidEndpoint: '接口地址无效或不存在',
    decisionModelErrorInvalidInput: '请求内容不符合要求',
    decisionModelErrorUnauthorized: 'API Key 无效或没有权限',
    decisionModelErrorInsufficientCredits: '账户余额不足',
    decisionModelErrorRateLimited: '请求太频繁，请稍后再试',
    decisionModelErrorTimeout: '请求超时，请检查网络或稍后重试',
    decisionModelErrorNetwork: '无法连接服务，请检查网络或代理设置',
    decisionModelErrorUpstream: '服务返回异常，请稍后重试',
    pluginsTitle: '插件管理',
    ...
    agentBrowserPasskeyHelp: '请在系统弹窗中完成验证。如果没有弹窗或找不到通行密钥，可取消验证，并在网页中选择“试试其他方式”，使用密码或手机确认。',
    agentBrowserPasskeyUnavailable: '当前内置浏览器无法使用本机通行密钥。可取消验证，并在网页中选择“试试其他方式”，使用密码或手机确认。',
    agentBrowserPasskeyExternalHelp: '如仍无法登录，可在浏览器设置中选择“使用独立浏览器窗口”，重新打开目标网站登录，并在新窗口继续任务。登录状态不会自动同步。',
    agentBrowserPasskeyCancel: '取消验证',
    agentBrowserPasskeySettings: '打开浏览器设置',
    ...
    browserCredentialManagerDescription: '登录密码由系统安全存储加密，供你授权后的自动登录使用。保存立即生效。',
    ...
    browserCredentialEncryptionUnavailable: '系统安全存储未获授权或暂时不可用。你可以重新授权，已保存的登录信息会保留。',
    browserCredentialAccessNotRequested: '启用安全存储后，即可保存登录密码。打开此设置页不会请求系统授权。',
    browserCredentialEnableAccess: '启用安全存储',
    browserCredentialRetryAccess: '重新授权',
    browserCredentialRequestingAccess: '正在请求授权…',
    browserCredentialAccessEnabled: '安全存储已启用，设置已记住。',
    browserCredentialAccessRestartRequired: '本次未能访问钥匙串。请完全退出并重新打开 LobsterAI，再到“设置 → 浏览器”点击“重新授权”。已保存的登录信息会保留。',
    browserCredentialRetryAfterRestart: '重启后可重新授权',
    browserCredentialMacAccessHint: '如 macOS 弹出钥匙串提示，请输入 Mac 登录密码并选择“始终允许”以记住授权。选择“拒绝”后，可按此处提示重新授权。',
    browserCredentialAccessFailed: '请求系统安全存储授权失败，请重试。',
    ...
    scheduledTasksDeliveryFailed: '推送失败',
    scheduledTasksReportReadyDeliveryFailed: '报告生成成功，推送失败',
    scheduledTasksReportSaved: '报告已保存，微信未收到时可单独补发。',
    scheduledTasksWeixinResend: '补发报告到微信',
    scheduledTasksWeixinResending: '正在补发…',
    scheduledTasksWeixinResent: '微信接口已接受补发，请在微信中确认收到。',
    scheduledTasksWeixinResendHint: '发送此份已保存报告至任务当前的微信接收人，不重新运行任务。',
    scheduledTasksWeixinContextExpired: '微信会话上下文已失效。请先在微信给机器人发一条消息，再补发报告。',
    scheduledTasksWeixinAccountExpired: '微信登录态已失效。请在微信渠道设置中重新登录，再补发报告。',
    ...
    emailSaving: '保存中...',
    emailDeleting: '删除中...',
    // Workspace changes review
    artifactDiffOld: '修改前',
    artifactDiffNew: '修改后',
    codeHighlightLoading: '正在加载语法高亮',
    codeHighlightMismatch: '源码版本不匹配，请刷新变更',
    codeHighlightTooLarge: '文件超出语法高亮大小限制',
    codeHighlightUnavailable: '缺少完整源码，保留原始差异',
    codeHighlightUnknown: '此语言暂不支持语法高亮',
    workspaceDiffReview: '审查',
    workspaceDiffScope: '审查范围',
    workspaceDiffScope_repository: '工作区',
    workspaceDiffScope_unstaged: '未暂存',
    workspaceDiffScope_staged: '已暂存',
    workspaceDiffScope_branch: '分支',
    workspaceDiffScope_commit: '指定提交',
    workspaceDiffScopeEmpty: '没有可读取的变更',
    workspaceDiffScopeUnavailable: '无法读取此审查范围，请重试',
    workspaceDiffReference: '分支或提交引用',
    workspaceDiffBranchReference: '基准分支，例如 main 或 origin/main',
    workspaceDiffCommitReference: '提交哈希或引用，例如 HEAD',
    workspaceDiffApply: '查看',
    workspaceDiffBase: '基准',
    workspaceDiffRestoredCurrent: '已重新读取此范围的审查，请核对当前版本。',
    workspaceDiffLoading: '正在读取差异…',
    workspaceDiffLoadFailed: '无法读取差异文件。',
    workspaceDiffFiles: '{count} 个文件已更改',
    workspaceDiffLayout: '差异视图',
    workspaceDiffUnified: '统一',
    workspaceDiffSplit: '并排',
    workspaceDiffShowFiles: '显示文件树',
    workspaceDiffHideFiles: '隐藏文件树',
    workspaceDiffFileTree: '文件树',
    workspaceDiffFilterFiles: '筛选文件…',
    workspaceDiffNoMatchingFiles: '没有匹配的文件',
    workspaceDiffModified: '已修改',
    workspaceDiffAdded: '新增文件',
    workspaceDiffDeleted: '删除文件',
    workspaceDiffRenamed: '重命名',
    workspaceDiffCopied: '复制文件',
    workspaceDiffMode: '文件权限变更',
    workspaceDiffBinary: '二进制文件已更改，无法显示文本差异。',
    workspaceDiffBinaryShort: '二进制',
    workspaceDiffModeOnly: '仅文件权限改变，内容未改变。',
    workspaceDiffPathOnly: '文件内容未改变。',
    workspaceDiffNoText: '没有可显示的文本差异。',
    workspaceDiffUnavailable: '此文件的文本差异未包含在当前预览中。',
    workspaceDiffNoNewline: '文件末尾无换行',
    workspaceDiffExpandContext: '展开未修改的上下文',
    workspaceDiffUnmodifiedLines: '{count} 行未修改',
    workspaceDiffMoreLines: '展开更多（还有 {count} 行）',
    workspaceDiffTruncated: '差异预览已截断。文件统计来自工作区，当前显示部分变更行。',
    workspaceDiffReadTruncated: '差异预览已截断，仅显示已读取的文件和变更行。',
  ...
  en: {
    ...
    coworkQuestionDockWaiting: 'Waiting for your answer',
    coworkQuestionDockSkip: 'Skip',
    coworkQuestionDockSubmit: 'Submit answers',
    coworkQuestionDockOther: 'Add your thoughts or enter another answer',
    coworkQuestionDockNavigation: 'Question navigation',
    coworkQuestionDockPrevious: 'Previous question',
    coworkQuestionDockNext: 'Next question',
    coworkQuestionDockRecommended: '(Recommended)',
    coworkQuestionDockClose: 'Dismiss and answer later',
    coworkQuestionDockQueue: '{count} question groups are waiting',
    coworkQuestionDockExpired: 'This question has expired',
    coworkQuestionDockSending: 'Submitting',
    // Common
    save: 'Save',
    cancel: 'Cancel',
    saving: 'Saving...',
    ...
    general: 'General',
    model: 'Model',
    settingsCustomModel: 'Model Settings',
    shortcuts: 'Shortcuts',
    about: 'About',
    ...
    intranetLoginPasswordRequired: 'Enter your password.',
    intranetLoginCancelled: 'Login cancelled.',
    intranetLoginFailed: 'Login failed. Please try again.',
    intranetLoginInvalidCredentials: 'Incorrect employee ID or password.',
    intranetLoginTimeout: 'Login timed out. Please try again.',
    intranetLoginNetworkError: 'Network error. Check your intranet connection and try again.',
    intranetLoginInvalidResponse: 'Unexpected response from the login service.',
    collapse: 'Collapse',
    expand: 'Expand',
    ...
    modelSelectorSubscriptionOfferDesc: 'Subscribe at {pricePercent}% of the regular price to unlock more models.',
    modelSelectorBoostOfferDesc: 'Buy a booster pack at {pricePercent}% of the regular price to keep using more models.',
    ...
    coworkActivityLiveWrite: 'Writing {target}',
    coworkActivityLiveWriteGeneric: 'Writing a file',
    coworkActivityLiveGenerating: 'Generating file content',
    coworkActivityStatusReplying: 'Writing the reply',
    coworkActivityStatusCommand: 'Running a command',
    coworkActivityStatusCommandOutput: 'Waiting for command output',
    coworkActivityStatusReading: 'Reading a file',
    coworkActivityStatusReadingSkill: 'Reading skill instructions',
    coworkActivityStatusWriting: 'Writing a file',
    coworkActivityStatusEditing: 'Editing a file',
    coworkActivityStatusSearchingFiles: 'Searching files',
    coworkActivityStatusSearchingWeb: 'Searching the web',
    coworkActivityStatusFetchingWeb: 'Reading a web page',
    coworkActivityStatusBrowser: 'Using the browser',
    coworkActivityStatusMemory: 'Searching memory',
    coworkActivityStatusTodo: 'Updating the task list',
    coworkActivityStatusAsking: 'Preparing a question',
    coworkActivityStatusCron: 'Setting up a scheduled task',
    coworkActivityStatusSubagentIo: 'Talking to a subagent',
    coworkActivityStatusMessaging: 'Sending a message',
    coworkActivityStatusViewingImage: 'Viewing an image',
    coworkActivityStatusTool: 'Using a tool',
    coworkActivityDoneCommandGeneric: 'Ran a command',
    coworkActivityDoneRead: 'Read {target}',
    coworkActivityDoneReadGeneric: 'Read a file',
    coworkActivityDoneWrite: 'Wrote {target}',
    coworkActivityDoneWriteGeneric: 'Wrote a file',
    coworkActivityDoneEdit: 'Edited {target}',
    coworkActivityDoneEditGeneric: 'Edited a file',
    coworkActivityDoneTool: 'Used {target}',
    coworkActivityDoneSpawnSubagent: 'Started a subagent',
    coworkActivityDoneImage: 'Generated an image',
    coworkActivityDoneVideo: 'Generated a video',
    ...
    coworkActivityWaitSubagentSummary: 'Subagents finished, waiting for summary',
    ...
    updateGrayUnavailable: 'This update is currently unavailable. Check for updates again.',
    ...
    lowCreditOfferClose: 'Close purchase reminder',
    lowCreditOfferFirstBadge: 'First purchase',
    lowCreditOfferBalance: '{credits} credits remaining',
    lowCreditOfferDescription: 'Low credits may interrupt tasks. Top up before they run out.',
    lowCreditOfferCountdown: 'Limited offer {time}',
    lowCreditOfferRecharge: 'Buy credits',
    lowCreditOfferUpgrade: 'Upgrade plan',
    lowCreditOfferSubscribe: 'Subscribe to a plan',
    lowCreditOfferDiscount: '{discount}0% price',
    lowCreditOfferDiscountRecharge: 'Top up at {discount}0% price',
    lowCreditOfferLimitedDiscount: 'Limited {discount}0% price',
    lowCreditOfferBadgeFirstTop: 'First',
    lowCreditOfferBadgeFirstBottom: 'offer',
    lowCreditOfferBadgeLimitedTop: 'Limited',
    lowCreditOfferBadgeLimitedBottom: 'offer',
    lowCreditOfferTaskFirstTitle: 'Credits used up. Upgrade at {discount}0% of the regular price',
    lowCreditOfferTaskReturningTitle: 'Credits used up. Limited {discount}0% price',
    ...
    decisionModelSettingsTitle: 'Jev decision model',
    decisionModelSettingsDesc: 'Lets the assistant call TypeSafe\'s Jev decision model. It writes no text: it classifies, scores, and answers yes/no about content, usually within a second and at a tiny cost, which suits bulk filtering and sorting. Bring your own API key.',
    decisionModelEnableLabel: 'Enable Jev decision model',
    decisionModelProviderLabel: 'Provider',
    decisionModelProviderOpenRouter: 'OpenRouter',
    decisionModelProviderTypeSafe: 'TypeSafe (official)',
    decisionModelProviderCompatible: 'Custom compatible endpoint',
    decisionModelEndpointLabel: 'Endpoint URL',
    decisionModelEndpointHint: 'The full request URL of an endpoint that speaks TypeSafe\'s /v1/systemone format, e.g. https://example.com/v1/systemone.',
    decisionModelTest: 'Test connection',
    decisionModelTesting: 'Testing…',
    decisionModelTestOk: 'Connected · {model} · {ms} ms',
    decisionModelTestFailed: 'Connection failed: {error}',
    decisionModelActiveNote: 'Active: the assistant calls Jev when it needs to classify, score, or check items in bulk.',
    decisionModelNeedsSetup: 'Add an API key and click Save below to turn it on.',
    decisionModelUnsavedHint: 'Changes take effect when you click Save below.',
    decisionModelExamplesTitle: 'Try asking:',
    decisionModelExample1: 'Sort the 200 customer reviews in this spreadsheet by sentiment and issue type, and flag the ones support should follow up on',
    decisionModelExample2: 'Screen these résumés for candidates who meet the job requirements and rank them by fit',
    decisionModelExample3: 'Which emails in my inbox need a reply today?',
    decisionModelDataNote: 'Content being judged is sent to the selected service. Saving after turning this on or off restarts the OpenClaw engine once.',
    decisionModelErrorMissingApiKey: 'No API key yet',
    decisionModelErrorInvalidEndpoint: 'The endpoint URL is invalid or doesn\'t exist',
    decisionModelErrorInvalidInput: 'The request was rejected as invalid',
    decisionModelErrorUnauthorized: 'The API key is invalid or lacks access',
    decisionModelErrorInsufficientCredits: 'The account is out of credits',
    decisionModelErrorRateLimited: 'Too many requests. Try again shortly',
    decisionModelErrorTimeout: 'The request timed out. Check your network or try again',
    decisionModelErrorNetwork: 'Couldn\'t reach the service. Check your network or proxy settings',
    decisionModelErrorUpstream: 'The service returned an error. Try again later',
    ...
    agentBrowserPasskeyHelp: 'Complete verification in the system prompt. If no prompt appears or your passkey is missing, cancel and choose “Try another way” on the page to use a password or phone confirmation.',
    agentBrowserPasskeyUnavailable: 'The built-in browser cannot use a passkey on this device. Cancel and choose “Try another way” on the page to use a password or phone confirmation.',
    agentBrowserPasskeyExternalHelp: 'If you still cannot sign in, choose “Use a separate browser window” in browser settings, reopen the site, and sign in there to continue your task. Sign-in state is not transferred automatically.',
    agentBrowserPasskeyCancel: 'Cancel verification',
    agentBrowserPasskeySettings: 'Open browser settings',
    ...
    browserCredentialManagerDescription: 'Login passwords are encrypted by secure OS storage and used for automatic sign-in with your permission. Saves apply immediately.',
    ...
    browserCredentialEncryptionUnavailable: 'Secure OS storage access was not granted or is temporarily unavailable. You can request access again. Existing saved logins are kept.',
    browserCredentialAccessNotRequested: 'Enable secure storage to save login passwords. Opening this settings page will not request OS access.',
    browserCredentialEnableAccess: 'Enable secure storage',
    browserCredentialRetryAccess: 'Request access again',
    browserCredentialRequestingAccess: 'Requesting access…',
    browserCredentialAccessEnabled: 'Secure storage is enabled. This setting is remembered.',
    browserCredentialAccessRestartRequired: 'Keychain access was unavailable. Fully quit and reopen LobsterAI, then go to Settings → Browser and click “Request access again”. Existing saved logins are kept.',
    browserCredentialRetryAfterRestart: 'Restart to request access',
    browserCredentialMacAccessHint: 'If macOS shows a Keychain prompt, enter your Mac login password and choose “Always Allow” to remember access. If you choose “Deny”, follow the instructions here to request access again.',
    browserCredentialAccessFailed: 'Failed to request secure OS storage access. Please try again.',
    ...
    scheduledTasksDeliveryFailed: 'Delivery failed',
    scheduledTasksReportReadyDeliveryFailed: 'Report generated; delivery failed',
    scheduledTasksReportSaved: 'Report saved. You can resend it if it did not arrive in WeChat.',
    scheduledTasksWeixinResend: 'Resend report to WeChat',
    scheduledTasksWeixinResending: 'Resending…',
    scheduledTasksWeixinResent: 'WeChat accepted the resend. Please confirm receipt in WeChat.',
    scheduledTasksWeixinResendHint: 'Sends this saved report to the task’s current WeChat recipient without rerunning the task.',
    scheduledTasksWeixinContextExpired: 'The WeChat conversation context expired. Message the bot in WeChat, then resend the report.',
    scheduledTasksWeixinAccountExpired: 'The WeChat login expired. Sign in again in channel settings, then resend the report.',
    ...
    // Workspace changes review
    artifactDiffOld: 'Before',
    artifactDiffNew: 'After',
    codeHighlightLoading: 'Loading syntax highlighting',
    codeHighlightMismatch: 'Source revision mismatch. Refresh changes.',
    codeHighlightTooLarge: 'File exceeds the syntax highlighting size limit',
    codeHighlightUnavailable: 'Full source unavailable; showing the original diff',
    codeHighlightUnknown: 'Syntax highlighting is unavailable for this language',
    workspaceDiffReview: 'Review',
    workspaceDiffScope: 'Review scope',
    workspaceDiffScope_repository: 'Workspace',
    workspaceDiffScope_unstaged: 'Unstaged',
    workspaceDiffScope_staged: 'Staged',
    workspaceDiffScope_branch: 'Branch',
    workspaceDiffScope_commit: 'Commit',
    workspaceDiffScopeEmpty: 'No changes are available',
    workspaceDiffScopeUnavailable: 'This review scope is unavailable. Try again.',
    workspaceDiffReference: 'Branch or commit reference',
    workspaceDiffBranchReference: 'Base branch, e.g. main or origin/main',
    workspaceDiffCommitReference: 'Commit hash or reference, e.g. HEAD',
    workspaceDiffApply: 'Review',
    workspaceDiffBase: 'Base',
    workspaceDiffRestoredCurrent: 'This review scope was reloaded. Check the current revision.',
    workspaceDiffLoading: 'Reading changes…',
    workspaceDiffLoadFailed: 'Unable to read the diff file.',
    workspaceDiffFiles: '{count} files changed',
    workspaceDiffLayout: 'Diff view',
    workspaceDiffUnified: 'Unified',
    workspaceDiffSplit: 'Split',
    workspaceDiffShowFiles: 'Show file tree',
    workspaceDiffHideFiles: 'Hide file tree',
    workspaceDiffFileTree: 'File tree',
    workspaceDiffFilterFiles: 'Filter files…',
    workspaceDiffNoMatchingFiles: 'No matching files',
    workspaceDiffModified: 'Modified',
    workspaceDiffAdded: 'Added file',
    workspaceDiffDeleted: 'Deleted file',
    workspaceDiffRenamed: 'Renamed',
    workspaceDiffCopied: 'Copied file',
    workspaceDiffMode: 'File mode changed',
    workspaceDiffBinary: 'Binary file changed. No text diff is available.',
    workspaceDiffBinaryShort: 'Binary',
    workspaceDiffModeOnly: 'Only the file mode changed. Contents are unchanged.',
    workspaceDiffPathOnly: 'File contents are unchanged.',
    workspaceDiffNoText: 'No text changes to display.',
    workspaceDiffUnavailable: 'The text diff for this file is not included in this preview.',
    workspaceDiffNoNewline: 'No newline at end of file',
    workspaceDiffExpandContext: 'Expand unchanged context',
    workspaceDiffUnmodifiedLines: '{count} unmodified lines',
    workspaceDiffMoreLines: 'Show more ({count} lines remaining)',
    workspaceDiffTruncated: 'This preview is truncated. File counts describe the workspace; only some changed lines are shown.',
    workspaceDiffReadTruncated: 'This preview is truncated. Only the files and changed lines read so far are shown.',
    workspaceDiffIncomplete: 'Some files exceed the read limit. Line counts are incomplete.',
  },
};
