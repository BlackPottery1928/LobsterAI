...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkActivityStatusPreparingWrite: '正在准备写入文件',
    coworkActivityStatusPreparingEdit: '正在准备修改文件',
    coworkActivityStatusCommand: '正在执行命令',
  ...
  en: {
    ...
    coworkActivityStatusPreparingWrite: 'Preparing to write a file',
    coworkActivityStatusPreparingEdit: 'Preparing to edit a file',
