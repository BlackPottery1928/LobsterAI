...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    taskPanelTitle: '任务管理',
    taskPanelToggle: '任务管理',
    taskPanelHeaderRunning: '{count} 个后台任务运行中',
    taskPanelMainAgent: '主智能体',
    taskPanelMainAgentRunning: '处理中',
    taskPanelMainAgentWaitingSubagents: '等待子智能体',
    taskPanelMainAgentWaitingSummary: '等待汇总',
    taskPanelMainAgentIdle: '待命',
    taskPanelSubagents: '子智能体',
    taskPanelSubagentsEmpty: '暂无子智能体',
    taskPanelViewAllSubagents: '查看全部',
    taskPanelBackgroundJobs: '后台任务',
    taskPanelBackgroundJobsEmpty: '暂无后台任务',
    taskPanelJobCount: '{total} 个后台任务',
    taskPanelJobCountRunning: '{total} 个后台任务 · {running} 运行中',
    taskPanelJobStatusRunning: '运行中',
    taskPanelJobStatusStopping: '停止中',
    taskPanelJobStatusCompleted: '已完成',
    taskPanelJobStatusKilled: '已终止',
    taskPanelJobStatusFailed: '失败',
    taskPanelJobStatusInterrupted: '已中断',
    taskPanelDurationHours: '{hours} 小时 {minutes} 分',
    taskPanelDurationMinutes: '{minutes} 分 {seconds} 秒',
    taskPanelDurationSeconds: '{seconds} 秒',
    taskPanelKill: '终止',
    taskPanelKillConfirm: '确认终止',
    taskPanelKillRequested: '已发送终止请求',
    taskPanelKillAlreadyFinished: '该任务已经结束',
    taskPanelKillNotFound: '运行时里找不到这个任务',
    taskPanelKillUnsupported: '当前无法终止：运行时未连接',
    taskPanelKillFailed: '终止失败',
    taskPanelCopy: '复制命令',
    taskPanelCopied: '命令已复制',
    taskPanelClearSettled: '清除已结束',
  ...
  en: {
    ...
    taskPanelToggle: 'Task management',
    taskPanelHeaderRunning: '{count} background tasks running',
    taskPanelMainAgent: 'Main agent',
    taskPanelMainAgentRunning: 'Working',
    taskPanelMainAgentWaitingSubagents: 'Waiting for subagents',
    taskPanelMainAgentWaitingSummary: 'Waiting for summary',
    taskPanelMainAgentIdle: 'Ready',
    taskPanelSubagents: 'Subagents',
    taskPanelSubagentsEmpty: 'No subagents',
    taskPanelViewAllSubagents: 'View all',
    taskPanelBackgroundJobs: 'Background tasks',
    taskPanelBackgroundJobsEmpty: 'No background tasks',
    taskPanelJobCount: '{total} background tasks',
    taskPanelJobCountRunning: '{total} background tasks · {running} running',
    taskPanelJobStatusRunning: 'Running',
    taskPanelJobStatusStopping: 'Stopping',
    taskPanelJobStatusCompleted: 'Completed',
    taskPanelJobStatusKilled: 'Killed',
    taskPanelJobStatusFailed: 'Failed',
    taskPanelJobStatusInterrupted: 'Interrupted',
    taskPanelDurationHours: '{hours}h {minutes}m',
    taskPanelDurationMinutes: '{minutes}m {seconds}s',
    taskPanelDurationSeconds: '{seconds}s',
    taskPanelKill: 'Stop',
    taskPanelKillConfirm: 'Confirm stop',
    taskPanelKillRequested: 'Stop requested',
    taskPanelKillAlreadyFinished: 'This task has already finished',
    taskPanelKillNotFound: 'The runtime no longer knows this task',
    taskPanelKillUnsupported: 'Cannot stop now: the runtime is not connected',
    taskPanelKillFailed: 'Failed to stop',
    taskPanelCopy: 'Copy command',
    taskPanelCopied: 'Command copied',
    taskPanelClearSettled: 'Clear finished',
