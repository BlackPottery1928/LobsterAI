...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    taskPanelMainAgent: '主代理',
    taskPanelMainAgentRunning: '运行中',
    taskPanelMainAgentIdle: '空闲',
    taskPanelSubagents: '子代理',
    taskPanelSubagentsEmpty: '暂无子代理',
    taskPanelSubagentsHint: '当前主代理派生的子代理将显示在这里',
    taskPanelViewAllSubagents: '查看全部',
    taskPanelBackgroundJobs: '后台任务',
    taskPanelBackgroundJobsEmpty: '暂无后台任务',
    taskPanelBackgroundJobsHint: '以后台方式启动的命令会显示在这里',
    ...
    coworkFilesChanged: '{count} 个文件已更改',
    coworkTurnChangesTitle: '本轮工作区变更',
    coworkTurnCaptureIncomplete: '本轮的最终变更未能完整记录，当前仅显示最近一次采集结果。',
    coworkChangeStatsIncomplete: '部分文件超出读取限额，行数统计不完整',
    artifactDiffOld: '修改前',
    artifactDiffNew: '修改后',
    ...
    workspaceDiffScopeEmpty: '没有可读取的上一轮变更',
  ...
  en: {
    ...
    taskPanelMainAgentRunning: 'Running',
    taskPanelMainAgentIdle: 'Idle',
    taskPanelSubagents: 'Subagents',
    taskPanelSubagentsEmpty: 'No subagents',
    taskPanelSubagentsHint: 'Subagents spawned by the main agent appear here',
    ...
    taskPanelBackgroundJobsHint: 'Commands started in the background appear here',
    ...
    // Workspace changes review
    coworkFilesChanged: '{count} files changed',
    coworkTurnChangesTitle: 'Changes during this turn',
    coworkTurnCaptureIncomplete: 'The final changes could not be captured. Showing the last available capture.',
    coworkChangeStatsIncomplete: 'Some files exceed the read limit; line counts are incomplete',
    ...
    workspaceDiffScope_turn: 'Last turn',
    ...
    workspaceDiffScopeEmpty: 'No previous turn changes are available',
