...
export const BUNDLED_SKILL_DISPLAY_NAMES: Record<string, LocalizedText> = {
  ...
  'contextweave-interactive-architecture': { zh: '架构图一键生成', en: 'Architecture Diagrams' },
  ...
  'unclecheng-reduce-ai-perception-v2': { zh: '去 AI 味', en: 'Humanizer' },
